...
class Testscrapy(unittest.TestCase):
    ...
    def test_getexcel(self):
        ...
        self.assertTrue(scrapy.oss_ask(url_cell, para_dict_cell, '%s/cell' % datestr, True))
    ...
    def test_getexcel1(self):
        ...
        self.assertEquals(scrapy.oss_ask(url_delete, para_dict_delete, '%s/cell' %  'data', True),)
